...
import BookingForm, {
  BookingDetails,
} from "../../components/Checkout/BookingForm";
...
export default function CheckoutPage() {
  ...
  const handleBook = () => {
    const bookingData = {
      ...
      total:
        65580 + selectedAddOns.filter((addOn) => addOn.selected).length * 1000,
    };
  ...
  const addOnsPrice =
    selectedAddOns.filter((addOn) => addOn.selected).length * 1000;
